...
done_testing();")
 ...
 '(tempbuf-temporary-major-modes (quote (Custom w3 Man view help apropos completion-list-mode dired ibuffer bookmark-bmenu-mode ess-help-mode compilation-mode vc-dir-mode vc-hg-log-view-mode occur-mode diff-mode magit-key-mode)))
 '(tool-bar-mode nil)
