...
done_testing();")
 ...
 '(tramp-gvfs-methods (quote ("dav" "davs" "obex" "synce" "ftp" "sftp")))
 '(tramp-mode t)
 '(tramp-persistency-file-name "/home/ryan/.emacs.d/persistence/tramp")
 '(tramp-remote-path (quote (tramp-default-remote-path "/bin" "/usr/bin" "/usr/sbin" "/usr/local/bin" "/local/bin" "/local/freeware/bin" "/local/gnu/bin" "/usr/freeware/bin" "/usr/pkg/bin" "/usr/contrib/bin" "/system/bin")))
