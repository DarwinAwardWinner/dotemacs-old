(custom-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "white" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 105 :width normal :foundry "unknown" :family "Ubuntu Mono"))))
...
done_testing();")
 ...
 '(tool-bar-mode nil)
 '(tramp-auto-save-directory "~/.emacs.d/persistence/tramp-auto-save-files")
